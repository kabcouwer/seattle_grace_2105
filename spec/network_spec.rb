...
RSpec.describe Network do
  ...
  describe 'instantiation' do
    it 'can add hospital to the network' do
      gsmn = Network.new("Greater Seattle Medical Network")
    ...
    it 'can return the highest paid doctor in network' do
      gsmn = Network.new("Greater Seattle Medical Network")
    ...
    it 'can return hash with hospitals as keys and doctors as values' do
      gsmn = Network.new("Greater Seattle Medical Network")
